...
const panels = [
    ...
    {id: 1, name: 'Design UI + Desenvolvimento Laravel', descricao:<p>Real Veiculos / Volkswagen <small>/ 2022</small></p>, src: ['image/Volkswagen-layout-site.png', 'image/volkswagen-design-ux-ui.webp']},
    {id: 2, name: 'Design UI + Desenvolvimento Laravel', descricao: <p>Honda <small>/ 2021</small></p>, src: ['image/honda-veiculos.jpg', 'image/honda-interfaces.webp']},
    {id: 3, name: 'Design UX/UI + Desenvolvimento Laravel + Wordpress', descricao: <p>Autoconf<small>/ 2021</small></p>, src: ['image/design-system-autoconf-bootstrap.webp', 'image/autoconf-design-system-mobile.webp', 'image/autoconf-design-system-desktop.webp', 'image/autoconf-kanban-ux-ui.webp', 'image/autoconf-sitemap.webp', 'image/autoconf-websites-templates.webp', 'image/layout-blog-autoconf-v2-01.jpg']},
    ...
    {id: 9, name: 'Direção de Arte Redes Sociais + Tabloides Gráficos', descricao:<p>Roldão / Perini <small>/ 2017</small></p>, src: ['image/roldao-posts.webp', 'image/megamidia.webp', 'image/megamidia-3.webp']},
    {id: 10, name: 'Design UX/UI + Desenvolvimento Wordpress', descricao:<p>Probat Leogap <small>/ 2016</small></p>, src: ['image/probat-leogap-website-2017.jpg', 'image/probat-leogap-wireframe-2017.jpg', null]},
    {id: 11, name: 'Design UI', descricao:<p>Globo Renault Florianópolis <small>/ 2016</small></p>, src: ['image/landing-reanult-globo.jpg']},
    ...
    {id: 14, name: 'Branding + Design UI + Desenvolvimento Wordpress', descricao:<p>Zeta Estaleiro <small>/ 2013</small></p>, src: ['image/zeta-estaleiro-redesign.jpg']},
    ...
    {id: 20, name: 'Websites + Projetos Gráficos + Design UI', descricao:<p>Diversos <small>/ 2004 / 2011</small></p>, src: ['image/inicio-taukane.jpg','image/varios-taukane.webp']}
];

const thumbis = [
    {id: 0, name: 'Website', src: 'image/dombertolin-thumb.jpg'},
    {id: 1, name: 'Design UI + Desenvolvimento Laravel', src: 'image/volks-thumb.jpg'},
    {id: 2, name: 'Design UI + Desenvolvimento Laravel', src: 'image/honda-thumb.jpg'},
    ...
    {id: 5, name: 'Design UI', src: 'image/laww-thumb.jpg'},
    ...
    {id: 10, name: 'Design UI + Desenvolvimento Wordpress', src: 'image/probat-thumb.jpg'},
    {id: 11, name: 'Design UI', src: 'image/globo-renault-thumb.jpg'},
    {id: 12, name: 'Branding', src: 'image/marmoraria-thumb.jpg'},
    {id: 13, name: 'Projeto Gráfico', src: 'image/jornal-independente-thumb.jpg'},
    {id: 14, name: 'Branding +  Design UI + Desenvolvimento Wordpress', src: 'image/zeta-estaleiro.jpg'},
    ...
    {id: 20, name: 'Direção de Arte', src: 'image/tauk-2004-thumb.jpg'},
];
