function Contato() { return ( 
    <div className="container text-primary p-md-5 p-3 bg-light rounded shadow-sm"> 
        <div className="row">
            <div className="col">
                <h3 className="w-100 fw-bold">Contato:</h3>
                <section className="d-md-flex align-items-center gap-5">
                    <p className="mb--md-0 mb-3 small"><a href="mailto:taukanepires@gmail.com">taukanepires@gmail.com</a></p>
                    <div>
                        <a
